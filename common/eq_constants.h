...
// These enumerations should not change unless the database is changed to match
...
#define MAX_BAGSLOTS				(uint8)255 // 0 - 254: may have to change if game bag sizes include 256
